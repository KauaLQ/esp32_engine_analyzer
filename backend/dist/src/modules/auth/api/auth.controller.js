...
const register_dto_1 = require("../domain/dto/register.dto");
const login_dto_1 = require("../domain/dto/login.dto");
const refresh_token_dto_1 = require("../domain/dto/refresh-token.dto");
const auth_response_dto_1 = require("../domain/dto/auth-response.dto");
const jwt_auth_guard_1 = require("../domain/guards/jwt-auth.guard");
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'User account is disabled' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
