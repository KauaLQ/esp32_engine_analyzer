...
const jwt_strategy_1 = require("./domain/strategies/jwt.strategy");
const roles_guard_1 = require("./domain/guards/roles.guard");
        ...
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (configService) => {
                    ...
                    const expiresInSeconds = Number(configService.get('JWT_EXPIRES_IN_SECONDS', '900'));
